...
| 使用 AI 功能 | 管理员后台 → AI 配置 | 每日一签 AI 需配置 DeepSeek API Key；AI 任务分析支持 DeepSeek / OpenAI / Claude / Kimi / 通义千问 / GLM / MiniMax。公网多人统一 AI 需要后端 AI Proxy。 |
...
| 配置 AI 功能 | 管理员后台 | 每日一签 AI 使用 DeepSeek；AI 任务分析支持 DeepSeek / OpenAI / Claude / Kimi / 通义千问 / GLM / MiniMax。均采用 BYOK，需要自行配置 API Key。 |
